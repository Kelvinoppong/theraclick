    ...
    <div className="flex min-h-screen items-center justify-center bg-white dark:bg-gray-950 px-4 py-12 md:py-16">
      <div className="mx-auto w-full max-w-2xl">
        ...
        <div className="mb-6 flex justify-center">
          <div className="rounded-full bg-primary-100 dark:bg-gray-800 p-4 md:p-5">
            <Shield className="h-8 w-8 text-primary-600 md:h-10 md:w-10" />
          </div>
        </div>
        <h1 className="mb-3 text-center text-3xl font-bold text-gray-900 dark:text-gray-100 md:text-4xl">
          Choose how you want to appear
        </h1>
        <p className="mb-12 text-center text-lg text-gray-600 dark:text-gray-300 md:text-xl">
          Your privacy is our priority
        </p>

        {/* Anonymous Mode Toggle */}
        <div className="mb-8 rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-5 md:p-6">
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="text-base font-semibold text-gray-900 dark:text-gray-100 md:text-lg">Anonymous Mode</p>
            ...
            <button
              ...
              className={`relative inline-flex h-7 w-12 items-center rounded-full transition-colors ${
                anonymousEnabled ? "bg-primary-500" : "bg-gray-300 dark:bg-gray-600"
              }`}
        ...
        <Card className="mb-8 border-gray-200 dark:border-gray-800">
          <CardContent className="p-5 md:p-6">
            <div className="mb-4 flex items-center gap-3">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 md:text-xl">Your Privacy Rights</h3>
            </div>
